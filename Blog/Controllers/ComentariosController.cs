...
namespace Blog.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        {
            var blogContext = _context.Comentario.Include(c => c.Mensagens);
        ...
        public async Task<IActionResult> Create([Bind("ComentarioId,Titulo,Descricao,Autor,MensagemId")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ComentarioId,Titulo,Descricao,Autor,MensagemId")] Comentario comentario)
        {
